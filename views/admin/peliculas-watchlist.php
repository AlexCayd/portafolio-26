<div class="admin-head">
    <div>
        ...
        <p>Mi selección curada a mano: los títulos que marco desde Gestionar (<?php echo count($watchlist); ?>).</p>
    </div>
...
<div class="card" style="margin-top:22px">
    <div class="card-head">
        <div><h3 style="margin:0 0 4px">Selección por mes</h3><p class="chart-sub" style="margin:0">Cuándo vi los títulos que forman la selección</p></div>
...
(function () {
    ...
    var chart = new Chart(document.getElementById('chartMes'), {
        type: 'bar',
        data: { labels: first.labels, datasets: [{ label: 'Títulos', data: first.data, backgroundColor: '#F5B400', borderRadius: 5, borderSkipped: false }] },
