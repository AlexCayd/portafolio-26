...
-- Tiempo de generación: 15-09-2026 a las 21:17:52
...
--
-- Estructura de tabla para la tabla `blog_recursos`
--
...
--
-- Estructura de tabla para la tabla `dias_reservacion`
--

CREATE TABLE `dias_reservacion` (
  `id` int(11) NOT NULL,
  `dia_semana` tinyint(4) NOT NULL COMMENT '0=Dom 1=Lun 2=Mar 3=Mie 4=Jue 5=Vie 6=Sab',
...
CREATE TABLE `feedback` (
  ...
  `calidad_sabor` tinyint(3) UNSIGNED NOT NULL,
  `atencion_mesero` tinyint(3) UNSIGNED NOT NULL,
  `tiempo_espera` tinyint(3) UNSIGNED NOT NULL,
  `experiencia_global` tinyint(3) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `horarios_reservacion`
--

CREATE TABLE `horarios_reservacion` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `impresoras` (
  `id` int(11) NOT NULL,
  `nombre` varchar(60) NOT NULL,
  `area_id` tinyint(3) UNSIGNED DEFAULT NULL COMMENT 'NULL = impresora de cuenta/caja',
  ...
  `puerto` int(11) NOT NULL DEFAULT 9100 COMMENT 'sólo aplica a conexion=red',
  `dispositivo` varchar(120) DEFAULT NULL COMMENT 'windows: nombre de impresora o smb://host/recurso',
  `ancho` tinyint(4) NOT NULL DEFAULT 48 COMMENT 'caracteres (48=80mm, 32=58mm)',
  `activo` tinyint(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `mesas` (
  ...
  `pos_x` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT 'Posición % horizontal (centro del pin)',
  `pos_y` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT 'Posición % vertical (centro del pin)',
  `activo` tinyint(1) NOT NULL DEFAULT 1,
...
CREATE TABLE `reservaciones` (
  ...
  `comentario_admin` text DEFAULT NULL COMMENT 'Comentario interno de operación',
...
CREATE TABLE `tickets` (
  `id` int(11) NOT NULL,
  `mesa_id` int(11) NOT NULL,
  `mesa_secundaria_id` int(11) DEFAULT NULL,
  ...
  `propina` decimal(8,2) NOT NULL DEFAULT 0.00 COMMENT 'Propina al cerrar = pagado − total de la cuenta',
...
CREATE TABLE `ticket_items` (
  ...
  `categoria` varchar(60) NOT NULL,
  `area_id` tinyint(3) UNSIGNED NOT NULL,
  `comensal` tinyint(3) UNSIGNED DEFAULT NULL COMMENT 'NULL = General',
...
--
-- Estructura de tabla para la tabla `ticket_pagos`
--

CREATE TABLE `ticket_pagos` (
  `id` int(10) UNSIGNED NOT NULL,
  `ticket_id` int(11) NOT NULL,
  `comensal` tinyint(3) UNSIGNED NOT NULL,
...
--
-- Indices de la tabla `blog_recursos`
--
...
--
-- Indices de la tabla `dias_reservacion`
--
...
--
-- Indices de la tabla `feedback_tokens`
--
...
--
-- Indices de la tabla `horarios_reservacion`
--
...
ALTER TABLE `reservaciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_reservaciones_fecha_estado_hora` (`fecha`,`estado`,`hora`),
  ADD KEY `idx_reservaciones_fecha_hora` (`fecha`,`hora`),
...
ALTER TABLE `reservacion_mesas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_reservacion_mesa` (`reservacion_id`,`mesa_id`),
  ADD UNIQUE KEY `uq_reservacion_orden` (`reservacion_id`,`orden`),
  ADD KEY `idx_rm_mesa` (`mesa_id`),
  ADD KEY `idx_rm_reservacion` (`reservacion_id`);
...
ALTER TABLE `tickets`
  ...
  ADD KEY `mesa_secundaria_id` (`mesa_secundaria_id`),
  ADD KEY `mesero_id` (`mesero_id`),
  ADD KEY `idx_estado_mesa` (`estado`,`mesa_id`),
  ADD KEY `idx_ticket_reservacion` (`reservacion_id`);
...
ALTER TABLE `ticket_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_area_estado` (`area_id`,`estado`),
  ADD KEY `idx_ti_ticket` (`ticket_id`);

--
-- Indices de la tabla `ticket_pagos`
--
ALTER TABLE `ticket_pagos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_tp_ticket` (`ticket_id`);
...
--
-- AUTO_INCREMENT de la tabla `blog_recursos`
--
ALTER TABLE `blog_recursos`
...
--
-- AUTO_INCREMENT de la tabla `dias_reservacion`
--
ALTER TABLE `dias_reservacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `feedback_tokens`
--
ALTER TABLE `feedback_tokens`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `horarios_reservacion`
--
ALTER TABLE `horarios_reservacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `ticket_pagos`
--
ALTER TABLE `ticket_pagos`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `blog_recursos`
--
ALTER TABLE `blog_recursos`
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`token_id`) REFERENCES `feedback_tokens` (`id`) ON DELETE SET NULL;

--
-- Filtros para la tabla `feedback_tokens`
--
ALTER TABLE `feedback_tokens`
  ADD CONSTRAINT `feedback_tokens_ibfk_1` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `horarios_reservacion`
--
ALTER TABLE `horarios_reservacion`
  ADD CONSTRAINT `horarios_reservacion_ibfk_1` FOREIGN KEY (`dia_id`) REFERENCES `dias_reservacion` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `impresoras`
  ADD CONSTRAINT `impresoras_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `areas_produccion` (`id`);
...
--
ALTER TABLE `menu`
  ADD CONSTRAINT `menu_ibfk_1` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`);

--
-- Filtros para la tabla `productos`
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `areas_produccion` (`id`);
...
--
-- Filtros para la tabla `reservacion_mesas`
--
ALTER TABLE `reservacion_mesas`
  ADD CONSTRAINT `fk_reservacion_mesas_mesa` FOREIGN KEY (`mesa_id`) REFERENCES `mesas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_reservacion_mesas_reservacion` FOREIGN KEY (`reservacion_id`) REFERENCES `reservaciones` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `tickets`
--
ALTER TABLE `tickets`
  ADD CONSTRAINT `tickets_ibfk_1` FOREIGN KEY (`mesa_id`) REFERENCES `mesas` (`id`),
  ADD CONSTRAINT `tickets_ibfk_2` FOREIGN KEY (`mesa_secundaria_id`) REFERENCES `mesas` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `tickets_ibfk_3` FOREIGN KEY (`reservacion_id`) REFERENCES `reservaciones` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `tickets_ibfk_4` FOREIGN KEY (`mesero_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `ticket_items`
  ...
  ADD CONSTRAINT `ticket_items_ibfk_2` FOREIGN KEY (`area_id`) REFERENCES `areas_produccion` (`id`);

--
-- Filtros para la tabla `ticket_pagos`
--
ALTER TABLE `ticket_pagos`
  ADD CONSTRAINT `ticket_pagos_ibfk_1` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE;
COMMIT;
