-- =====================================================================
--  DDL — Estructura de la base de datos del portafolio Alexander Oliva
--  Motor: MySQL / MariaDB (mysqli)
--  Uso:  mysql -u root < database/ddl.sql
-- =====================================================================

CREATE DATABASE IF NOT EXISTS alexander_oliva
