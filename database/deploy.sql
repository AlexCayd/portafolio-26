...
START TRANSACTION;
SET time_zone = "+00:00";
-- Las tablas se insertan por orden alfabetico (p. ej. horario_bloques antes que
-- materias), asi que se desactiva la verificacion de llaves foraneas durante la carga.
...
(1, 'Sobrevivir a internet', 'Dominique Wolton', 'leido', 1, 1, NULL, NULL, '2026-07-20', '2026-07-21 03:35:11'),
(2, 'WTF con el SAT', 'Paulina Casso', 'leido', 1, 2, NULL, NULL, '2026-07-20', '2026-07-21 03:35:20'),
(3, 'Neuromarketing en acción', 'Néstor Braidot', 'leido', 1, 3, NULL, NULL, '2026-07-20', '2026-07-21 03:35:33'),
(4, 'Orgullo Prieto', 'Tenoch Huerta', 'leido', 1, 4, NULL, NULL, '2026-07-20', '2026-07-21 03:35:46'),
(5, 'Dibujo y Comunicación Gráfica', 'Rosa Puente', 'leido', 1, 5, NULL, NULL, '2026-07-20', '2026-07-21 03:35:58'),
(6, 'El arte de la guerra', 'Sun Tzu', 'leido', 1, 6, NULL, NULL, '2026-07-20', '2026-07-21 03:36:07'),
(7, 'Heartstopper 3', 'Alice Oseman', 'leido', 1, 7, NULL, NULL, '2026-07-20', '2026-07-21 03:36:24'),
(8, 'El arte de tener razón', 'Arthur Schopenhauer', 'leido', 1, 8, NULL, NULL, '2026-07-20', '2026-07-21 03:36:52'),
(9, 'Heartstopper 4', 'Alice Oseman', 'leido', 1, 9, NULL, NULL, '2026-07-20', '2026-07-21 03:37:01'),
(10, 'Historia universal contemporánea', 'Dolores Nieto Rivero', 'leido', 1, 10, NULL, NULL, '2026-07-20', '2026-07-21 03:37:18'),
(11, 'Fechas que marcaron la historia de México', 'Editorial Época', 'leido', 1, 11, NULL, NULL, '2026-07-20', '2026-07-21 03:37:39'),
...
(173, 'La sociedad del cansancio', 'Byung Chul Han', 'pendiente', 0, 164, NULL, NULL, NULL, '2026-07-21 04:29:21'),
...
(348, 'Las historias que nunca contamos', 'Martha Figueroa', 'pendiente', 0, 339, NULL, NULL, NULL, '2026-07-21 05:23:08'),
...
--
-- Registros de PRUEBA (eliminar cuando ya no se necesiten): fechas de completado
-- distintas para verificar el orden por recencia, la paginacion, la busqueda y el
-- reordenamiento. Los leidos mas recientes (23/22/21-jul) encabezan la lista.
--

INSERT INTO `libros` (`id`, `titulo`, `autor`, `estado`, `completado`, `posicion`, `estrellas`, `comentario`, `fecha_leido`, `creado`) VALUES
(5001, 'Prueba 01 — Dune', 'Frank Herbert', 'leido', 1, 5001, 4.5, 'Reseña de prueba para verificar el comentario.', '2026-07-23', '2026-07-23 12:00:00'),
(5002, 'Prueba 02 — 1984', 'George Orwell', 'leido', 1, 5002, 5.0, NULL, '2026-07-22', '2026-07-23 12:00:00'),
(5003, 'Prueba 03 — Rayuela', 'Julio Cortázar', 'leido', 1, 5003, 3.5, NULL, '2026-07-21', '2026-07-23 12:00:00'),
(5004, 'Prueba 04 — El Aleph', 'Jorge Luis Borges', 'leido', 1, 5004, 2.5, NULL, '2026-07-15', '2026-07-23 12:00:00'),
(5005, 'Prueba 05 — Ficciones', 'Jorge Luis Borges', 'leido', 1, 5005, 4.0, NULL, '2026-07-05', '2026-07-23 12:00:00'),
(5006, 'Prueba 06 — Cosmos', 'Carl Sagan', 'leido', 1, 5006, 5.0, NULL, '2026-06-28', '2026-07-23 12:00:00'),
(5007, 'Prueba 07 — Sapiens II', 'Yuval Noah Harari', 'leido', 1, 5007, 3.0, NULL, '2026-06-15', '2026-07-23 12:00:00'),
(5008, 'Prueba 08 — El Hobbit', 'J. R. R. Tolkien', 'leido', 1, 5008, 4.5, NULL, '2026-06-02', '2026-07-23 12:00:00'),
(5009, 'Prueba 09 — Fundación', 'Isaac Asimov', 'leido', 1, 5009, 5.0, NULL, '2026-05-20', '2026-07-23 12:00:00'),
(5010, 'Prueba 10 — Neuromante', 'William Gibson', 'leido', 1, 5010, 3.5, NULL, '2026-05-08', '2026-07-23 12:00:00'),
(5011, 'Prueba 11 — Solaris', 'Stanisław Lem', 'leido', 1, 5011, 2.0, NULL, '2026-04-26', '2026-07-23 12:00:00'),
(5012, 'Prueba 12 — La Odisea', 'Homero', 'leido', 1, 5012, 4.0, NULL, '2026-04-14', '2026-07-23 12:00:00'),
(5013, 'Prueba 13 — Hamlet', 'William Shakespeare', 'leido', 1, 5013, 5.0, NULL, '2026-04-01', '2026-07-23 12:00:00'),
(5014, 'Prueba 14 — El Quijote', 'Miguel de Cervantes', 'leido', 1, 5014, 4.5, NULL, '2026-03-18', '2026-07-23 12:00:00'),
(5015, 'Prueba 15 — Ulises', 'James Joyce', 'leido', 1, 5015, 1.5, NULL, '2026-03-05', '2026-07-23 12:00:00'),
(5016, 'Prueba P1 — Pendiente A', 'Autor Prueba', 'pendiente', 0, 6001, NULL, NULL, NULL, '2026-07-23 12:00:00'),
(5017, 'Prueba P2 — Pendiente B', 'Autor Prueba', 'pendiente', 0, 6002, NULL, NULL, NULL, '2026-07-23 12:00:00'),
(5018, 'Prueba P3 — Pendiente C', 'Autor Prueba', 'pendiente', 0, 6003, NULL, NULL, NULL, '2026-07-23 12:00:00'),
(5019, 'Prueba P4 — Pendiente D', 'Autor Prueba', 'pendiente', 0, 6004, NULL, NULL, NULL, '2026-07-23 12:00:00');
...
(1, '/', 'Inicio', 30, '2026-07-22 16:17:43'),
(12, '/tekhne', 'Tékhne', 2, '2026-07-21 07:50:18'),
(15, '/tekhne/categoria/cultura', 'Cultura — Tékhne', 0, '2026-07-21 00:59:08'),
(18, '/tekhne/categoria/cuentos', 'Cuentos — Tékhne', 0, '2026-07-21 00:59:08'),
(22, '/tekhne/categoria/actualidad', 'Actualidad — Tékhne', 0, '2026-07-21 00:59:08');
